<%-- 
    Document   : unicalendar
    Created on : Jul 12, 2018, 7:45:19 PM
    Author     : sanda
--%>
	...
	<div id="fh5co-about">
		<div class="container">
				<div class="row row-pb-md">
                    ...
                    <button class="accordion"> <b> Events of our University</b></button>
    ...
    <br>
        ...
        <br>
            ...
            <div class="facilities12">
                ...
                <div class="lc">
                    <a href="AddeventUNI.jsp">Add Events</a><br>
...
<a href="universities.jsp"><input type="button" class="btn btn-primary" value="Go back" /></a>
                </div>
