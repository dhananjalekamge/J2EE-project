<%-- 
    ...
    Created on : Jul 6, 2018, 1:45:15 PM
    Author     : sanda
--%>
...
<html>
  ...
  <form id="new1" name="new" method="post" action="">
   
    
  
  <b> <label> USERNAME: </label> </b>
  <input type="text" placeholder="Enter Username" name=""><br> <br>
  
  <b><label> PASSWORD : </label> </b>
  <input type="password" placeholder="Enter Password" name=""> <br><br>
  ...
  <b><label> Doesn't have an account? </label></b> <br>
