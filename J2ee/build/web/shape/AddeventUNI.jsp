<%-- 
    Document   : AddeventUNI
    Created on : Jul 12, 2018, 8:07:03 PM
    Author     : sanda
--%>
...
<html>
	...
	<div id="fh5co-about">
        ...
        <br>
            ...
            <form action="AfterAddEventUNI.jsp" >
            ...
            <table>
                ...
                <tr><td>Events :</td><td><textarea rows="2" cols="50" name="events" value="" ></textarea></td></tr>
                 ...
                 <tr><td></td>
                     <td><input type="submit" class="btn btn-primary" value="submit" /></td></tr>
...
%>
        ...
        <br>
         <a href="unicalendar.jsp"><button class="btn btn-primary">Done</button></a>
<br><br><br>
